...
levelRoutes.get('/',controller.listLevels); levelRoutes.get('/kode-otomatis',controller.generateLevelCode); levelRoutes.get('/:id',controller.getLevel); levelRoutes.post('/',controller.createLevel); levelRoutes.put('/:id',controller.updateLevel); levelRoutes.delete('/:id',controller.deleteLevel);
